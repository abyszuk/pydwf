...
This code was generated from the Digilent Waveforms C header file::
    ...
    file ......... : dwf.h
    size ......... : 47009 bytes
    md5sum ....... : 670fc8ba690cbe0f848444c6f1458682
    version ...... : 3.16.3
"""
...
def dwf_function_signatures(typespec: Any) -> List[Tuple[str, Any, List[Tuple[str, Any]], bool]]:
    """Return type information for the 406 functions in the DWF C library API.
    ...
    return [
        ...
        ('FDwfAnalogOutNodeFunctionInfo', typespec.c_int, [ ('hdwf', typespec.HDWF), ('idxChannel', typespec.c_int), ('node', typespec.DwfAnalogOutNode), ('pfsfunc', typespec.c_int_ptr) ], False),
