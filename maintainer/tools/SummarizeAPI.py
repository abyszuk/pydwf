...
from pydwf.core.auxiliary.dwf_function_signatures import dwf_function_signatures, dwf_version
...
def report_api_categories():
    ...
    for (name, rettype, params, obsolete_flag) in function_signatures:
        ...
        elif name.startswith("FDwfDigitalSwd"):
            category = "FDwfDigitalSwd"
        ...
        elif name.startswith("FDwfSpectrum"):
            category = "FDwfSpectrum"
        else:
